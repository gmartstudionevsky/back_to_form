...
- **Блюда/рецепты**: ингредиенты, категории, тип готовки, порции и питание по порции (рассчитывается автоматически по продуктам с учётом коэффициентов готовки). 
- **Напитки**: калории/макросы и коэффициент гидратации. 
- **Фильтры и поиск**: быстрый поиск по библиотекам питания с фильтрами по меткам и типу готовки, а также редактирование карточек прямо в библиотеке. 
